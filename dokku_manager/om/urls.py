...
urlpatterns = [
    ...
    path('password_reset/done/', auth_views.password_reset_done, {'template_name': 'om/password_reset_done.html' },
    ...
    path('reset/done/', auth_views.password_reset_complete, {'template_name': 'om/password_reset_complete.html' }, name='password_reset_complete'),


    path('password_change/', auth_views.password_change, { 'template_name': 'om/password_change.html'}, name='password_change'),
    path('password_change/done/', auth_views.password_change_done, { 'template_name': 'om/password_change_complete.html' }, name='password_change_done'),
